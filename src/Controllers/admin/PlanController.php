...
class PlanController extends Controller
{
    ...
    public function table()
    {
        $res = new Result();
        try {
            authorization($this->connection, 'plan', 'listar');
    ...
    public function id()
    {
        $res = new Result();
        try {
            authorization($this->connection, 'plan', 'modificar');
    ...
    public function create()
    {
        $res = new Result();
        try {
            authorization($this->connection, 'plan', 'crear');
            $postData = file_get_contents('php://input');
            $body = json_decode($postData, true);
    ...
    public function delete()
    {
        $res = new Result();
        try {
            authorization($this->connection, 'plan', 'eliminar');
            $postData = file_get_contents('php://input');
            $body = json_decode($postData, true);
